...
- [x] **MENU-02**: Menu bar icon animates or changes while a vim session is active
- [x] **MENU-03**: Menu includes a Quit option
- [x] **MENU-04**: App launches at login (optional, configurable)

### Configuration

- [x] **CONF-01**: User can configure the path to the vim binary (defaults to vim in PATH)
